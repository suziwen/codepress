...
CodePress = {
	...
	findString : function() {
		// opera seems to be missing find in page javascript support
		/*
		gecko method, doesn't work in opera:
		if(self.find(cc))
	...
	syntaxHighlight : function(flag) {
		...
		if(flag!='init')
		{
			...
			// uncomment above line when fixing returning the caret to its original position
			// the relevent code is in the findString function
		}
		...
		x = x.replace(/\n/g, '<br>');
		// there are problems with tabs collapsing
		// replace them with spaces for now
		x = x.replace(/\t/g, '   ');
